...
ALL_LAYERNORM_LAYERS.append(XyzRMSNorm)
...
class XyzAttention(nn.Module):
    ...
    def __init__(self, config: XyzConfig, layer_idx: Optional[int] = None):
        ...
        self.rotary_emb = XyzRotaryEmbedding(config=self.config)
...
class XyzDecoderLayer(nn.Module):
...
class XyzForCausalLMBase(XyzPreTrainedModel, GenerationMixin):
