...
def gaudi_exaone_rmsnorm_forward(self, hidden_states):
    ...
    """
    logger.warning_once("set `--optimum_habana`, call `gaudi_exaone_rmsnorm_forward`")
...
class GaudiExaoneSdpaAttention(ExaoneSdpaAttention):
    def __init__(self, *args, **kwargs):
        logger.warning_once("set `--optimum_habana`, call `GaudiExaoneSdpaAttention.__init__`")
    ...
    def forward(
        ...
        **kwargs,
        ...
        logger.warning_once("set `--optimum_habana`, call `GaudiExaoneSdpaAttention.forward`")
...
def gaudi_exaone_block_forward(
    ...
    **kwargs,
    ...
    logger.warning_once("set `--optimum_habana`, call `gaudi_exaone_block_forward`")
...
def gaudi_exaone_model_forward(
    ...
    logger.warning_once("set `--optimum_habana`, call `gaudi_exaone_model_forward`")
...
class GaudiExaoneForCausalLM(ExaoneForCausalLM):
    def __init__(self, config, parallel_strategy: DistributedStrategy = NoOpStrategy):
        logger.warning_once("set `--optimum_habana`, call `GaudiExaoneForCausalLM.__init__`")
    ...
    def forward(
        ...
        logger.warning_once("set `--optimum_habana`, call `GaudiExaoneForCausalLM.forward`")
        output_attentions = output_attentions if output_attentions is not None else self.config.output_attentions
        output_hidden_states = (
            output_hidden_states if output_hidden_states is not None else self.config.output_hidden_states
        )
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        logger.warning_once("set `--optimum_habana`, call `GaudiExaoneForCausalLM.prepare_inputs_for_generation`")
